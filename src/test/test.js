...
describe("basho", () => {
  ...
  //   (await toResult(output)).should.equal("hello, world\n");
  // });
  ...
  //   (await toResult(output)).should.equal("10000\n");
  // });
  ...
  //   (await toResult(output)).should.equal("21\n10\n");
  // });
  ...
  //   );
  //   (await toResult(output)).should.equal("40000\n");
  // });
  ...
  //   (await toResult(output)).should.equal("N1\nN2\nN3\nN4\n");
  // });
  ...
  //   );
  //   (await toResult(output)).should.equal("jes, 100\n");
  // });
  ...
  //   );
  //   (await toResult(output)).should.equal("kai\nniki\n");
  // });
  ...
  //   );
  //   (await toResult(output)).should.equal("1 2 3\n3 4 5\n");
  // });
  ...
  //   );
  //   (await toResult(output)).should.equal("4\n");
  // });
  ...
  //   );
  //   (await toResult(output)).should.equal("3\n4\n");
  // });
  ...
  //   );
  //   (await toResult(output)).should.equal("a0\nb1\nc2\n");
  // });
  ...
  //   );
  //   (await toResult(output)).should.equal("110\n");
  // });
  ...
  //   (await toResult(output)).should.equal("20\n");
  // });
  ...
  //   const result = await execute(
  //     `${basho} [10,20,30,40] -j x+1 -j x+2 --stack 0,2 -j x`
  //   );
  //   (await toResult(output)).should.equal("[ 10, 20, 30, 40 ]\n[ 11, 21, 31, 41 ]\n");
  // });

  // it(`Prints the correct version with -v`, async () => {
  //   const packageJSON = require("../../package.json");
  //   const result = await execute(`${basho} "-v"`);
  //   (await toResult(output)).should.equal(`${packageJSON.version}\n`);
  // });
